...
<template>
  <div id="app">
      <form>
        <div>
          <label for="">Título de la tarjeta: </label>
        ...
        <div>
          ...
          <select v-model="chip">
            ...
            <option :value="images.chipSrc">Chip</option>
          </select>
        </div>
        ...
        <div>
          ...
          <select v-model="type">
            <option selected value="">Seleccione una opción</option>
            <option :value="images.visaSrc">Visa</option>
          </select>
        </div>
      </form>
      ...
      <div class="carnet">
        ...
        <div>
          <h2>{{ number }}</h2>
          <span>Fecha Exp: <b>{{ expiration }}</b></span>
        </div>
        <footer>
          <span>{{ owner.toUpperCase() }}</span>
          <img :src="type" width="60" alt="" />
        </footer>
      </div>
    </div>
  </template>
